## NOTE: leave some blank lines to improve readability
...
## NOTE: note that length(temperatures) returns the number of _columns_!
...
temperaturesF
# j)
## Hint: use the shortcuts 1:5 and -(6,7)
